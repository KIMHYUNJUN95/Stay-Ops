...
## Implementation Status Summary (as of 2026-06-03)
...
The in-app notification center (`/mobile/notifications`) and the `notifications` table are live. The `order_processed` type is the only dispatch path in the current implementation.
