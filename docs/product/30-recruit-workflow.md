...
## 채용 사이트 어드민 폐지 — 관리는 전부 StayOps (2026-09-24 결정, 미실행)
...
1. **읽지 않은 문의가 남아 있다**(2026-09-24 확인 시점 3건). 화면을 지우면 읽을 수단이 사라진다.
   내용을 먼저 확인·회신하거나 내보낸 뒤에 지운다.
2. **지원자에게 남는 연락 수단이 없어진다.** 채팅이 유일한 문의 창구였다면, 공고 페이지에 전화번호나
   이메일 같은 대체 안내를 두고 나서 없앤다.
