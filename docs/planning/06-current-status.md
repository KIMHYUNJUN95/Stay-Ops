...
- Google OAuth login (login screen placeholder present, not implemented).
...
| Google OAuth not implemented | Low | Login screen placeholder only; magic-link is primary |
