...
const ko: AdminTasksDictionary = {
  ...
  inboxNote: "정리 전 보관함 — 빠른 추가는 여기로 저장됩니다.",
  ...
  emInbox: "관리함이 비어 있습니다", emInboxS: "떠오르는 일을 빠르게 적어두고 나중에 정리하세요.",
...
const ja: AdminTasksDictionary = {
  ...
  inboxNote: "整理前の保管箱 — クイック追加はここに保存されます。",
  ...
  emInbox: "管理箱が空です", emInboxS: "思いついたことを素早くメモして後で整理しましょう。",
...
const en: AdminTasksDictionary = {
  ...
  inboxNote: "Staging inbox — quick-adds land here.",
  ...
  emInbox: "Your inbox is empty", emInboxS: "Capture ideas quickly and organize them later.",
